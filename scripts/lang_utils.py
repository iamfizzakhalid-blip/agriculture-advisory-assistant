...
def translate_to_original_language(text: str, target_language: str) -> str:
    ...
    "- Use proper Urdu written in Arabic script (نستعلیق style).\n"
    "- Use Pakistani Urdu vocabulary exclusively.\n"
    "- DO NOT use Hindi words, Sanskrit-derived vocabulary, or Devanagari-influenced phrasing.\n"
    ...
    "  'khaad', 'kasht', 'katai', 'sindh', 'gandum', 'makki', 'kapaas',\n"
    "  'ganna', 'dawai', 'keera', 'bimari', 'mausam'\n"
    "- Sentence structure should match how Pakistanis actually speak and type.\n"
    "- Do NOT use formal/literary Urdu. Write conversationally.\n\n"

    "STRICTLY FORBIDDEN HINDI/SANSKRIT WORDS (NEVER USE ANY OF THESE):\n"
    "matra, spasht, adhik, krishi, jal, avashyak, ropan, beejan,\n"
    "fasal utpadan, mitti prabandhan, khet, kheti, kisaan (use 'kashtkaar'),\n"
    "paudha (use 'pouda'), ped (use 'darakht'), phool, sabzi (use 'sabziyan'),\n"
    "ugana (use 'ugaana/kasht karna'), gehun (use 'gandum'),\n"
    "dhan (use 'chawal'), kapas (use 'kapaas'), ganna (OK),\n"
    "keetnashak (use 'keeron ki dawai'), kharpatwar (use 'jari booti'),\n"
    "sinchai (use 'aabpashi' or 'pani dena'), upaj (use 'paidawaar'),\n"
    "vishesh (use 'khaas'), samay (use 'waqt'), prakar (use 'qism'),\n"
    "pranali (use 'tareeqa'), sambhav (use 'mumkin'),\n"
    "samasya (use 'masla'), suraksha (use 'hifazat'),\n"
    "vikas (use 'taraqqi'), kshetra (use 'ilaqa'),\n"
    "prayas (use 'koshish'), parinaam (use 'nateeja')\n\n"

    "REPLACEMENT RULE: If you catch yourself writing any Hindi-style word,\n"
    "STOP and replace it with the Pakistani Urdu equivalent listed above.\n\n"

    "STYLE REQUIREMENTS:\n"
    "- Keep language simple, natural, and conversational.\n"
    "- Write as if explaining to a Pakistani farmer face-to-face.\n"
    "- Avoid formal, bookish, or literary language.\n"
    "- Keep sentences short and direct.\n\n"

    "FINAL INSTRUCTION:\n"
    "Return ONLY the translated text.\n"
    "No explanations, no English words mixed in, no notes, no commentary."
)
